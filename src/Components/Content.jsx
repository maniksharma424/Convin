...
const Content = () => {
  ...
  const ShowAddCardModal = useSelector(
    (store) => store.modal?.showAddCardModal
  );
  ...
  const showDeleteVideoModal = useSelector(
    (store) => store?.modal?.deleteModal
  );
